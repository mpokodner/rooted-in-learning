...
export default function Home() {
  return (
    <div className="min-h-screen bg-new-light">
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="slide-up">
              ...
              <h1 className="text-balance mb-4 md:mb-6 text-onyx">
                Bridging Pedagogy and Technology
              </h1>

              <p className="text-base md:text-lg text-onyx-muted mb-6 md:mb-8 max-w-xl leading-relaxed">
              ...
              <div className="flex flex-wrap items-center gap-3 md:gap-6 text-xs md:text-sm text-onyx-muted">
                ...
                <span className="text-calm-spirit hidden sm:inline">•</span>
                <div className="flex items-center gap-1.5 md:gap-2">
                  <svg
                    className="w-3.5 h-3.5 md:w-4 md:h-4"
                    fill="none"
            ...
            <div className="relative slide-up stagger-2">
              <div className="bg-white rounded-xl md:rounded-2xl shadow-xl overflow-hidden border border-border">
                {/* Window Header */}
                <div className="flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-2.5 md:py-3 bg-rooted-earth">
                  <span className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-womb-bloom"></span>
                  <span className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-sacred-ember"></span>
                  <span className="w-2.5 h-2.5 md:w-3 md:h-3 rounded-full bg-moss"></span>
                </div>
                {/* Dashboard Content */}
              ...
              {/* Floating Stats Card */}
              <div className="absolute -bottom-3 left-2 md:-bottom-4 md:left-4 bg-white rounded-lg md:rounded-xl shadow-lg p-3 md:p-4 border border-border">
      ...
      {/* Stats Bar */}
      <section className="stats-bar py-6 md:py-8 lg:py-10">
        <div className="container">
          <div className="grid grid-cols-3 gap-4 md:gap-8 text-center">
            <div className="flex flex-col items-center">
              <div className="flex flex-col md:flex-row items-center gap-1 md:gap-2 mb-1 md:mb-2">
                <svg
                  className="w-5 h-5 md:w-6 md:h-6 text-calm-spirit hidden md:block"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
      ...
      {/* Built for Modern Classrooms - Projects Section */}
      <section className="section bg-new-light" id="projects">
        <div className="container">
          ...
          <div className="grid grid-3 gap-4 md:gap-6 mb-6 md:mb-8">
            ...
            <div className="product-card hover-lift">
              <div className="product-card-image bg-gradient-to-br from-womb-bloom/20 to-gentle-hold p-4 md:p-6 flex items-center justify-center">
                <div className="bg-white rounded-lg shadow-md p-3 md:p-4 w-full flex flex-col gap-2">
                  <div className="h-2.5 md:h-3 bg-calm-spirit/30 rounded w-3/4"></div>
                  <div className="h-2.5 md:h-3 bg-calm-spirit/30 rounded w-full"></div>
                  <div className="h-2.5 md:h-3 bg-calm-spirit/30 rounded w-2/3"></div>
                  <div className="h-2.5 md:h-3 bg-sacred-ember/30 rounded w-1/2 mt-2"></div>
                </div>
              </div>
              <div className="product-card-content">
                <h4 className="font-semibold text-onyx mb-1">
            ...
            <div className="product-card hover-lift">
              <div className="product-card-image bg-gradient-to-br from-moss/10 to-gentle-hold p-4 md:p-6 flex items-center justify-center">
                <div className="bg-white rounded-lg shadow-md p-3 md:p-4 w-full">
                  <div className="text-[10px] md:text-xs font-semibold text-rooted-earth mb-2 uppercase tracking-wide">
                    Gamified
                  </div>
      ...
      {/* Featured Product - Favorites Section */}
      <section className="section bg-new-light" id="favorites">
        <div className="container">
          <div className="bg-white rounded-xl md:rounded-2xl shadow-lg overflow-hidden border border-border">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              {/* Product Image */}
              <div className="relative bg-gradient-to-br from-womb-bloom/30 to-gentle-hold p-6 md:p-8 flex items-center justify-center min-h-[250px] md:min-h-[300px]">
                <span className="absolute top-3 left-3 md:top-4 md:left-4 badge badge-featured">
                  #1 Bestseller
                </span>
                <div className="bg-white rounded-lg md:rounded-xl shadow-xl p-3 md:p-4 transform -rotate-3 hover:rotate-0 transition-transform">
              ...
              <div className="p-6 md:p-8 lg:p-12 flex flex-col justify-center">
                <div className="flex items-center gap-2 mb-2 md:mb-3">
                  <span className="text-[10px] md:text-xs font-medium text-onyx-muted uppercase tracking-wide">
                    Productivity
                  </span>
                  <span className="px-2 py-0.5 bg-gentle-hold rounded text-[10px] md:text-xs font-medium text-onyx">
                    Notion
                  </span>
                </div>
                <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-onyx mb-2 md:mb-3">
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-xl md:rounded-2xl overflow-hidden border border-border flex flex-col md:flex-row">
                <div className="md:w-1/3 bg-gradient-to-br from-womb-bloom/30 to-gentle-hold p-4 md:p-6 flex items-center justify-center min-h-[120px]">
                  <div className="text-5xl md:text-6xl">👩‍🏫</div>
                </div>
                <div className="md:w-2/3 p-5 md:p-6 lg:p-8">
                  <div className="flex items-center gap-2 text-[10px] md:text-xs text-onyx-muted mb-2 md:mb-3">
                  ...
                  <h3 className="text-lg md:text-xl font-bold text-onyx mb-2 md:mb-3">
      ...
      <section id="contact" className="sr-only">
        {/* This is an anchor for the contact button - the footer newsletter serves as the contact section */}
      </section>
