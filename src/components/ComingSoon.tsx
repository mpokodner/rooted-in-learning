...
export default function ComingSoon({
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] flex flex-col">
      {/* Header */}
      <header className="py-5 md:py-6 border-b border-[#E8DED0]">
        <div className="container">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2.5 hover:opacity-80 transition-opacity">
              ...
              <span className="text-base font-semibold text-[#5C6B4A]">
                Rooted in Learning
              </span>
            </Link>
      ...
      {/* Footer */}
      <footer className="py-6 border-t border-[#E8DED0]">
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <a href="#" className="w-9 h-9 rounded-full bg-[#F5EFE7] flex items-center justify-center text-[#666666] hover:bg-[#D9D5CE] hover:text-[#2D2D2D] transition-colors" aria-label="Website">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                </svg>
              </a>
              <a href="#" className="w-9 h-9 rounded-full bg-[#F5EFE7] flex items-center justify-center text-[#666666] hover:bg-[#D9D5CE] hover:text-[#2D2D2D] transition-colors" aria-label="Email">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
