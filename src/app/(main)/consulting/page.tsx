...
export default function ConsultingPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--neutral-bg)]">
      ...
      <section className="assessalign-preview">
        <div className="consulting-container">
          <div className="assessalign-preview-header">
            <p className="assessalign-preview-label">Currently In Development</p>
            <h2 className="assessalign-preview-title">Sneak Peek: AssessAlign</h2>
            <p className="assessalign-preview-desc">
          ...
          <div className="assessalign-card">
            <div className="assessalign-card-banner">
              <div className="assessalign-card-badge">
                <div className="assessalign-card-badge-icon">
                  <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <span className="assessalign-card-badge-text">Project Preview</span>
              </div>
              <h3 className="assessalign-card-name">AssessAlign</h3>
              <p className="assessalign-card-tagline">
            ...
            <div className="assessalign-card-body">
              <div className="assessalign-features">
                {[
                  ...
                  <div key={i} className="assessalign-feature">
                    <div className="assessalign-feature-icon">
                      <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                        <path strokeLinecap="round" strokeLinejoin="round" d={feature.icon} />
                      </svg>
                    </div>
                    <p className="assessalign-feature-text">{feature.label}</p>
                  </div>
                ))}
              </div>
              <div className="assessalign-actions">
                <Link href="/consulting/assessalign" className="assessalign-btn-preview">
                  <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <Link href="/about#contact" className="assessalign-btn-access">
