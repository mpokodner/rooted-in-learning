    ...
    <footer className="bg-[#5C6B4D]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-16">
            ...
            <div className="lg:col-span-4">
              <Link href="/" className="inline-flex items-center gap-2.5 mb-5">
                <div className="w-9 h-9 bg-white/15 rounded-[0.5rem] flex items-center justify-center">
              ...
              <p className="text-[#C5D1B8] text-sm mb-6 max-w-sm leading-[1.6]">
      ...
      <div className="border-t border-white/10">
        <div className="container py-6 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-xs text-[#8B9B7A] text-center md:text-left uppercase tracking-[0.05em]">
