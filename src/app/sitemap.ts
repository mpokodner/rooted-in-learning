...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://therootedlearner.com";
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/resources/teacher-tools`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
