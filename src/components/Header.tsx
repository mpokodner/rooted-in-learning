    ...
    <header className="sticky top-0 z-50 bg-[#FAF8F5]/95 backdrop-blur-md border-b border-[#E8E4DD]">
      <nav className="container">
        <div className="flex items-center justify-between h-[72px]">
          ...
          {/* Mobile Menu Button */}
          <button
            className="lg:hidden p-2.5 text-[#2D2D2D] hover:bg-[#EDE8E0] rounded-[0.5rem] transition-colors"
          ...
          <div className="lg:hidden pb-6 border-t border-[#E8E4DD] pt-4">
            <div className="flex flex-col gap-1">
              ...
              <div className="pt-4 mt-3 border-t border-[#E8E4DD]">
                <Link
                  href="/#contact"
                  className="block w-full bg-[#5C6B4D] text-white text-center py-3 rounded-[0.75rem] font-semibold text-sm hover:bg-[#4A5740] transition-colors"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Contact
                </Link>
