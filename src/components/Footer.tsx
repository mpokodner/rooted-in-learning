    ...
    <footer>
      ...
      <section className="bg-rooted-earth py-12 md:py-16">
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-10 mb-10 md:mb-14">
            {/* Brand Column */}
            <div className="col-span-2 lg:col-span-2">
              <Link href="/" className="flex items-center gap-2.5 mb-4 md:mb-5">
                <div className="w-9 h-9 md:w-10 md:h-10 bg-white/10 rounded-lg flex items-center justify-center">
                  <svg
              ...
              <p className="text-calm-spirit text-sm mb-5 md:mb-6 max-w-xs leading-relaxed">
            ...
            {/* Explore Links */}
            <div>
              <h5 className="font-semibold text-sacred-ember mb-4 text-xs uppercase tracking-widest">
                Explore
              </h5>
          ...
          <div className="border-t border-white/10 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-calm-spirit text-center md:text-left">
              © {new Date().getFullYear()} Rooted in Learning. All rights
              reserved.
            </p>
            <p className="text-sm text-calm-spirit">
              Built with{" "}
              <span className="text-sacred-ember font-medium">intention</span>{" "}
              in Austin, TX
            </p>
          </div>
        </div>
