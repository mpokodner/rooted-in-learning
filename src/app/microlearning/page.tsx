...
export default function MicrolearningPage() {
  return (
    <div className="min-h-screen bg-[#FAF8F5]">
      ...
      {/* Hero Section */}
      <section className="hero-section bg-gradient-to-b from-[#EDE8E0] to-[#FAF8F5]">
        <div className="container text-center">
          ...
          <h1 className="text-[2.5rem] md:text-[3.5rem] lg:text-[4rem] font-bold text-[#2D2D2D] leading-[1.1] tracking-[-0.02em] mb-2">
            Rooted in Learning
          </h1>
      ...
      {/* Category Filter */}
      <section className="section-sm bg-[#FAF8F5] sticky top-[72px] z-40 border-b border-[#E8E4DD]">
        <div className="container">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <select className="bg-white border border-[#E8E4DD] rounded-[0.75rem] px-4 py-2.5 text-sm text-[#2D2D2D] focus:outline-none focus:border-[#C17F5E] min-w-[140px]">
        ...
        <div className="container">
          <div className="flex items-center justify-between mb-10 md:mb-12">
            <div>
              ...
              <h2 className="text-[1.5rem] md:text-[2rem] font-bold text-[#2D2D2D] leading-[1.2]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 md:gap-6">
            ...
            <div className="lg:col-span-2 bg-white rounded-[1.5rem] overflow-hidden border border-[#E8E4DD] shadow-lg hover:shadow-xl transition-all">
              <div className="grid md:grid-cols-5">
                <div className="md:col-span-2 bg-gradient-to-br from-[#EDE8E0] to-[#D9D5CE] p-8 md:p-10 flex items-center justify-center min-h-[240px] md:min-h-[280px] relative">
                ...
                <div className="md:col-span-3 p-6 md:p-8 lg:p-10 flex flex-col justify-center">
                  ...
                  <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-[#2D2D2D] mb-4 leading-tight">{featuredBundle.title}</h3>
                  <p className="text-sm text-[#666666] mb-6 leading-relaxed">{featuredBundle.description}</p>
                  <div className="flex items-baseline gap-3 mb-6">
                    <span className="text-2xl md:text-3xl font-bold text-[#2D2D2D]">${featuredBundle.price.toFixed(2)}</span>
                  ...
                  <button className="bg-[#5C6B4D] text-white px-6 py-3.5 md:py-4 rounded-[0.75rem] font-semibold text-sm inline-flex items-center justify-center gap-2.5 hover:bg-[#4A5740] transition-all shadow-md w-full md:w-auto">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              {sideProducts.map((product) => (
                <div key={product.id} className="bg-white rounded-[1rem] border border-[#E8E4DD] p-5 md:p-6 hover:shadow-lg hover:-translate-y-0.5 transition-all group">
                  <div className="flex items-start gap-4">
                    <div className="w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-[#EDE8E0] to-[#D9D5CE] rounded-[0.75rem] flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
                    ...
                    <div className="flex-1">
                      ...
                      <span className="text-lg md:text-xl font-bold text-[#2D2D2D]">${product.price.toFixed(2)}</span>
                    </div>
                    <button className="w-9 h-9 md:w-10 md:h-10 rounded-full border-2 border-[#E8E4DD] flex items-center justify-center text-[#666666] hover:bg-[#5C6B4D] hover:text-white hover:border-[#5C6B4D] transition-all shrink-0">
                      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <section className="section bg-white">
        <div className="container">
          <div className="mb-10 md:mb-12">
            ...
            <h2 className="text-[1.5rem] md:text-[2rem] font-bold text-[#2D2D2D] leading-[1.2]">Mindful Morning Starters</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
            {morningStarters.map((product, index) => (
              <div key={product.id} className="bg-white rounded-[1rem] border border-[#E8E4DD] overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all group">
                ...
                <div className="p-5 md:p-6">
                  ...
                  <h4 className="font-bold text-[#2D2D2D] text-base mb-3 min-h-[44px] leading-snug">{product.title}</h4>
            ...
            {/* Membership Card */}
            <div className="bg-gradient-to-br from-[#5C6B4D] to-[#4A5740] rounded-[1rem] p-6 md:p-7 flex flex-col justify-center text-center">
      ...
      {/* Newsletter Section */}
      <section className="section bg-[#EDE8E0]">
        <div className="container">
          <div className="bg-white rounded-[1.5rem] shadow-xl p-8 md:p-12 lg:p-14 border border-[#E8E4DD]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 items-center">
              <div>
                ...
                <h2 className="text-[1.5rem] md:text-[2rem] font-bold text-[#2D2D2D] mb-4 leading-[1.2]">Join 5,000+ Educators</h2>
              ...
              <div>
                <div className="flex flex-col sm:flex-row gap-3 mb-3">
                  ...
                  <button className="bg-[#5C6B4D] text-white px-8 py-3.5 md:py-4 rounded-[0.75rem] text-sm font-semibold hover:bg-[#4A5740] transition-all shadow-md whitespace-nowrap">
                    Join Now
                  </button>
                </div>
