...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#FAF8F5]">
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="max-w-xl">
              {/* Badge */}
              <div className="inline-flex items-center gap-2.5 px-4 py-2 bg-[#EDE8E0] rounded-full mb-8">
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                <Link
                  href="/microlearning"
                  className="bg-[#5C6B4D] text-white px-6 py-3.5 md:px-8 md:py-4 rounded-full text-sm font-semibold inline-flex items-center gap-2.5 hover:bg-[#4A5740] transition-all shadow-sm"
                >
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-6 -left-4 md:bottom-10 md:-left-8 bg-white rounded-[1rem] shadow-xl p-4 md:p-5 border border-[#E8E4DD] max-w-[220px]">
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-[0.75rem] bg-[#EDE8E0] flex items-center justify-center shrink-0">
          ...
          <div className="mt-10 md:mt-14">
            <div className="bg-white rounded-[1rem] shadow-lg border border-[#E8E4DD] p-5 md:p-6 flex flex-col sm:flex-row items-center justify-between gap-4 max-w-xl">
              <div className="flex items-center gap-4">
                <span className="text-[10px] font-bold text-[#C17F5E] uppercase tracking-[0.15em]">
                  Weekly Newsletter
                </span>
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                <input
                  ...
                  className="flex-1 sm:w-44 px-4 py-2.5 text-sm border border-[#E8E4DD] rounded-[0.75rem] focus:outline-none focus:border-[#5C6B4D] bg-white"
                />
                <button className="bg-[#5C6B4D] text-white px-5 py-2.5 rounded-[0.75rem] text-sm font-semibold hover:bg-[#4A5740] transition-all whitespace-nowrap">
                  Join Now
                </button>
              </div>
            </div>
      ...
      <section className="section-lg bg-[#FAF8F5]">
        <div className="container">
          <div className="text-center max-w-2xl mx-auto mb-12 md:mb-16">
            <p className="text-[11px] font-bold text-[#C17F5E] uppercase tracking-[0.15em] mb-4">
              Our Ecosystem
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6 lg:gap-8">
            {/* Analytics Dashboard */}
            <div className="bg-white rounded-[1.25rem] p-6 md:p-8 border border-[#E8E4DD] hover:shadow-lg hover:-translate-y-1 transition-all group">
              <div className="w-14 h-14 rounded-[0.75rem] bg-[#EDE8E0] flex items-center justify-center mb-5">
      ...
      <section className="section bg-[#F0EDE7]">
        <div className="container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 md:gap-6">
            {/* Featured Article */}
            <div className="lg:col-span-3 bg-white rounded-[1.5rem] overflow-hidden border border-[#E8E4DD] shadow-sm">
              ...
              <div className="p-6 md:p-8">
                <div className="flex items-center gap-2 text-xs text-[#666666] mb-3">
                  <span className="font-bold text-[#C17F5E] uppercase tracking-[0.08em]">Leadership</span>
                  <span>•</span>
                  <span>Oct 24</span>
                </div>
            ...
            {/* Product Card */}
            <div className="lg:col-span-2 bg-[#EDE8E0] rounded-[1.5rem] p-6 md:p-8 flex flex-col justify-center items-center text-center">
              ...
              <button className="bg-[#5C6B4D] text-white px-6 py-3 rounded-[0.75rem] font-semibold text-sm inline-flex items-center gap-2 hover:bg-[#4A5740] transition-all shadow-md">
