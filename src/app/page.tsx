        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 md:gap-6 max-w-3xl mx-auto">
            ...
            <a
              ...
              className="group bg-[var(--white)] rounded-[var(--radius-xl)] p-6 border border-[var(--border-beige)] card-lift text-center"
            >
              ...
              <h3 className="text-[var(--text-base)] font-bold text-[var(--text-dark)] mb-1">
                YouTube
              </h3>
